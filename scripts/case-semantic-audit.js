...
const COMMAND_OWNERS = {
  ...
  pgfpointorigin: owner("src/engine/evaluate.js:resolvePgfFormOnlyPatternPoint", "partial", "pgfcorepatterns.code.tex"),
  ...
  pgfusepathqstroke: owner("src/tikz/libraries/arrows.js:parseDeclaredArrow", "partial", "pgfcorepathusage.code.tex"),
