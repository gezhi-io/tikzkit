export const texPackage = {
  ...
  "observedOptions": [],
  "registryNoteSuffix": "Legacy middle axes with `tick align=outside` now move their default terminal x/y labels through the completed-axis anchor calibration in `renderAxisLabels`; `activation-functions` aligns at its arrow tips. Evidence is in docs/qa/2026-08-05-pgfplots-middle-axis-terminal-labels.md. The zero-preserving middle-axis family now applies the native 10% surveyed-range expansion for an inferred far bound under `enlargelimits=true`; x-square-with-circle verifies y=0..2.475 before the independent transform reserve. Evidence is in docs/qa/2026-08-05-pgfplots-middle-axis-enlargelimits.md. General multi-axis placement, modern ticklabel* cs, full enlarge-limit grammar, and final text/bbox calibration remain partial.",
