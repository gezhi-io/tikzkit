export const texPackage = {
  ...
  "observedOptions": ["domain", "samples", "id", "fp", "color", "line width", "style", "xstep", "ystep", "sub", "subxstep", "subystep", "ratio", "label", "right space", "left space", "up space", "down space", "noticks", "tickwd", "tickup", "tickdn", "ticklt", "tickrt", "step", "trig", "frac", "orig", "np off", "node font", "xlabel style", "ylabel style"],
