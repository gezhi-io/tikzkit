export const texPackage = {
  ...
  "features": [
    ...
    "per-column int detect, fixed/fixed zerofill, sci/sci zerofill/sci subscript/sci superscript, precision, sci precision, and use comma number printing",
  ...
  "localSourceReviewed": [
    ...
    "/usr/local/texlive/2025/texmf-dist/tex/generic/pgf/math/pgfmathfloat.code.tex (number printer defaults precision to 2, configures fixed/sci/zerofill/decimal separators, and selects standard 10^n or direct 1_{n}/1^{n} scientific output, lines 819-899 and 976-1059)",
