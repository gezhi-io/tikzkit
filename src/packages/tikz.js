export const texPackage = {
  "name": "tikz",
  "status": "builtin",
  "implementedBy": "src/frontend/parser.js + src/engine/evaluate.js:interpretPathStatement/transformCanvasTransform/resolvedTextFontSpec/resolveAutoInlineNodePoint/autoInlineNodeAnchor/inlineNodePathTangent + src/tex/fontSpec.js + src/tikz/textMetrics.js + src/renderers/svg/textLayout.js + src/renderers/svg/richText.js + src/renderers/svg/renderSvg.js",
  ...
  "localSourceReviewedLatest": "/usr/local/texlive/2025/texmf-dist/tex/generic/pgf/frontendlayer/tikz/tikz.code.tex (/tikz/use as bounding box is an executable path mode, lines 534 and 1958; path-node pos/auto/swap/sloped options and local-tangent compass anchor tables, lines 1095-1125 and 4462-4535; cubic timer delegates to pgftransformcurveattime, lines 4948-4950); /usr/local/texlive/2025/texmf-dist/tex/generic/pgf/basiclayer/pgfcorepathusage.code.tex (/pgf/use as bounding box invokes PGF's bounding-box callback, line 41); /usr/local/texlive/2025/texmf-dist/tex/generic/pgf/basiclayer/pgfcoretransformations.code.tex (pgftransformcurveattime computes the point plus normalized tangent frame and upright correction, lines 566-590); /usr/local/texlive/2025/texmf-dist/doc/generic/pgf/pgfmanual-en-tikz-shapes.tex (path-node pos, auto, swap, sloped, and allow upside down semantics, lines 1866-2040); /Library/TeX/texbin/tikztosvg (local wrapper creates standalone[crop,tikz,multi=false] then appends fragment input)",
  "caseCount": 1077,
  "caseExamples": [
