...
\tikzset{
  ...
  Quad compact/.style={Quad,minimum width=1.65cm},
  Quad/.style={tikzquads base,shape=tikzquads quad,minimum width=2.35cm,minimum height=1.42cm,tikzquads kind=quad},
  ...
  BB/.style={Black Box},
  Black Box/.style={tikzquads base,shape=tikzquads black box,minimum width=1.35cm,minimum height=1.42cm,tikzquads kind=black box},
  Thevenin/.style={Black Box,tikzquads kind=thevenin},
  Norton/.style={Black Box,tikzquads kind=norton},
  PG load line/.style={draw,shape=tikzquads pg load line,minimum width=2.2cm,minimum height=1.7cm,tikzquads kind=pg load line},
