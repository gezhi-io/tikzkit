...
export const tikzLibrary = {
  ...
  "features": [
    ...
    "curved terminal arrow crops on circular and elliptical nodes"
  ],
  "implements": [
    "->",
    "<-",
