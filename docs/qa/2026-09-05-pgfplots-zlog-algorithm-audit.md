...
| --- | ---: | --- | --- | --- | --- | --- |
| `\addplot` | 1 | 23 | src/pgfplots/addplotParser.js | /usr/local/texlive/2025/texmf-dist/tex/generic/pgfplots/pgfplots.code.tex | partial | verified |
...
| `\end` | 3 | 26, 27, 28 | src/frontend/parser.js | /usr/local/texlive/2025/texmf-dist/tex/latex/base/latex.ltx | stable | verified |
...
| --- | --- | --- | --- | --- | --- |
| axis | `grid` | `major` | 6 | src/pgfplots/axisOptions.js | verified |
| axis | `height` | `7cm` | 6 | src/pgfplots/axisOptions.js | verified |
| axis | `log basis z` | `2` | 6 | src/pgfplots/axisOptions.js | verified |
| axis | `view` | `{35}{25}` | 6 | src/pgfplots/axisOptions.js | verified |
| axis | `width` | `10cm` | 6 | src/pgfplots/axisOptions.js | verified |
| axis | `xlabel` | `{Pipeline stage}` | 6 | src/pgfplots/axisOptions.js | verified |
| axis | `xmax` | `4` | 6 | src/pgfplots/axisOptions.js | verified |
| axis | `xmin` | `0` | 6 | src/pgfplots/axisOptions.js | verified |
| axis | `ylabel` | `{Batch}` | 6 | src/pgfplots/axisOptions.js | verified |
| axis | `ymax` | `2` | 6 | src/pgfplots/axisOptions.js | verified |
| axis | `ymin` | `0` | 6 | src/pgfplots/axisOptions.js | verified |
| axis | `zlabel` | `{Throughput}` | 6 | src/pgfplots/axisOptions.js | verified |
| axis | `zmax` | `16` | 6 | src/pgfplots/axisOptions.js | verified |
...
| --- | --- | ---: | --- | --- | --- |
| literal | `0` | 3 | 24 | src/engine/units.js | verified |
| literal | `1` | 8 | 24 | src/engine/units.js | verified |
| literal | `16` | 1 | 24 | src/engine/units.js | verified |
| literal | `2` | 2 | 24 | src/engine/units.js | verified |
| literal | `3` | 1 | 24 | src/engine/units.js | verified |
| literal | `4` | 2 | 24 | src/engine/units.js | verified |
| literal | `8` | 1 | 24 | src/engine/units.js | verified |
| option:axis | `0` | 2 | 10, 12 | src/pgfplots/axisOptions.js | verified |
| option:axis | `1` | 1 | 14 | src/pgfplots/axisOptions.js | verified |
| option:axis | `10cm` | 1 | 7 | src/pgfplots/axisOptions.js | verified |
| option:axis | `16` | 1 | 15 | src/pgfplots/axisOptions.js | verified |
| option:axis | `2` | 2 | 13, 17 | src/pgfplots/axisOptions.js | verified |
| option:axis | `25` | 1 | 9 | src/pgfplots/axisOptions.js | verified |
| option:axis | `35` | 1 | 9 | src/pgfplots/axisOptions.js | verified |
| option:axis | `4` | 1 | 11 | src/pgfplots/axisOptions.js | verified |
| option:axis | `7cm` | 1 | 8 | src/pgfplots/axisOptions.js | verified |
