...
| --- | --- | --- | --- | --- | --- |
| axis | `domain` | `-2:2` | 6 | src/pgfplots/axisOptions.js | verified |
| axis | `grid` | `both` | 6 | src/pgfplots/axisOptions.js | verified |
| axis | `height` | `8cm` | 6 | src/pgfplots/axisOptions.js | verified |
| axis | `samples` | `13` | 6 | src/pgfplots/axisOptions.js | verified |
| axis | `view` | `{45}{30}` | 6 | src/pgfplots/axisOptions.js | verified |
| axis | `width` | `10cm` | 6 | src/pgfplots/axisOptions.js | verified |
| axis | `xlabel` | `{$x$}` | 6 | src/pgfplots/axisOptions.js | verified |
| axis | `y domain` | `-2:2` | 6 | src/pgfplots/axisOptions.js | verified |
| axis | `ylabel` | `{$y$}` | 6 | src/pgfplots/axisOptions.js | verified |
| axis | `zlabel` | `{Intensity $I$}` | 6 | src/pgfplots/axisOptions.js | verified |
| axis | `zmax` | `1000` | 6 | src/pgfplots/axisOptions.js | verified |
| axis | `zmin` | `0.1` | 6 | src/pgfplots/axisOptions.js | verified |
...
| --- | --- | ---: | --- | --- | --- |
| expression:addplot:1 | `1000` | 1 | 21 | src/pgfplots/expressions.js | verified |
| option:axis | `-2` | 2 | 10, 11 | src/pgfplots/axisOptions.js | verified |
| option:axis | `0.1` | 1 | 14 | src/pgfplots/axisOptions.js | verified |
| option:axis | `1000` | 1 | 15 | src/pgfplots/axisOptions.js | verified |
| option:axis | `10cm` | 1 | 7 | src/pgfplots/axisOptions.js | verified |
| option:axis | `13` | 1 | 12 | src/pgfplots/axisOptions.js | verified |
| option:axis | `2` | 2 | 10, 11 | src/pgfplots/axisOptions.js | verified |
| option:axis | `30` | 1 | 9 | src/pgfplots/axisOptions.js | verified |
| option:axis | `45` | 1 | 9 | src/pgfplots/axisOptions.js | verified |
...
| ---: | --- | --- | --- |
| 21 | `1000*exp(-(x*x+y*y))` | src/pgfplots/expressions.js | verified |
