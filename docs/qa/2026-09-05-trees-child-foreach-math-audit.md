# Semantic Audit: child-foreach-math.tex
...
| `\cos` | 1 | 18 | src/renderers/svg/mathNode.js | - | partial | verified |
...
| `\op` | 3 | 18, 19, 21 | source declaration | - | source-local | verified |
| `\order` | 2 | 20, 21 | source declaration | - | source-local | verified |
| `\sin` | 1 | 18 | src/renderers/svg/mathNode.js | - | partial | verified |
...
| tikzpicture | `level 1/.style` | `{sibling distance=46mm}` | 11 | src/engine/options.js | verified |
| tikzpicture | `level 1/.style / sibling distance` | `46mm` | 11 | src/engine/options.js | verified |
| tikzpicture | `level 2/.style` | `{sibling distance=16mm}` | 11 | src/engine/options.js | verified |
| tikzpicture | `level 2/.style / sibling distance` | `16mm` | 11 | src/engine/options.js | verified |
| tikzpicture | `level distance` | `13mm` | 11 | src/engine/options.js | verified |
| tikzset | `derivative/.style` | `{draw,rounded corners=2pt,inner sep=2pt}` | 5 | src/engine/options.js | verified |
| tikzset | `derivative/.style / draw` | `true` | 5 | src/engine/options.js | verified |
| tikzset | `derivative/.style / inner sep` | `2pt` | 5 | src/engine/options.js | verified |
| tikzset | `derivative/.style / rounded corners` | `2pt` | 5 | src/engine/options.js | verified |
| tikzset | `term/.style` | `{draw,circle,minimum size=8mm,inner sep=1pt}` | 5 | src/engine/options.js | verified |
| tikzset | `term/.style / circle` | `true` | 5 | src/engine/options.js | verified |
| tikzset | `term/.style / draw` | `true` | 5 | src/engine/options.js | verified |
| tikzset | `term/.style / inner sep` | `1pt` | 5 | src/engine/options.js | verified |
| tikzset | `term/.style / minimum size` | `8mm` | 5 | src/engine/options.js | verified |

## Variables And Definitions

| Kind | Name | Value/domain | Line | References | Review |
| --- | --- | --- | ---: | --- | --- |
| foreach-variable | `\op` | \sin/red,\cos/blue | 18 | 2 (19, 21) | verified |
| foreach-variable | `\tone` | \sin/red,\cos/blue | 18 | 1 (19) | verified |
| foreach-variable | `\order` | 1,2 | 20 | 1 (21) | verified |
...
| option:tikzpicture | `13mm` | 1 | 13 | src/engine/options.js | verified |
| option:tikzpicture | `16mm` | 1 | 15 | src/engine/options.js | verified |
| option:tikzpicture | `2` | 1 | 15 | src/engine/options.js | verified |
| option:tikzpicture | `46mm` | 1 | 14 | src/engine/options.js | verified |
...
| order | `1` | 1 | 20 | src/engine/units.js | verified |
| order | `2` | 1 | 20 | src/engine/units.js | verified |
