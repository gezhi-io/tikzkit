...
| --- | --- | --- | --- | --- | --- |
| addplot | `blue!75!black` | `true` | 21 | src/pgfplots/addplotParser.js | verified |
| addplot | `domain` | `0:1` | 21, 28 | src/pgfplots/addplotParser.js | verified |
| addplot | `fill` | `cyan!24` | 35 | src/pgfplots/addplotParser.js | verified |
| addplot | `fill opacity` | `0.72` | 35 | src/pgfplots/addplotParser.js | verified |
| addplot | `name path` | `sinpath`<br>`cospath` | 21, 28 | src/pgfplots/addplotParser.js | verified |
| addplot | `red!75!black` | `true` | 28 | src/pgfplots/addplotParser.js | verified |
| addplot | `samples` | `65` | 21, 28 | src/pgfplots/addplotParser.js | verified |
| addplot | `very thick` | `true` | 21, 28 | src/pgfplots/addplotParser.js | verified |
...
| axis | `title` | `{Alternating regions between sine and cosine}` | 8 | src/pgfplots/axisOptions.js | verified |
| axis | `width` | `10cm` | 8 | src/pgfplots/axisOptions.js | verified |
| axis | `xlabel` | `{$x$}` | 8 | src/pgfplots/axisOptions.js | verified |
| axis | `xmax` | `1` | 8 | src/pgfplots/axisOptions.js | verified |
| axis | `xmin` | `0` | 8 | src/pgfplots/axisOptions.js | verified |
| axis | `ylabel` | `{$y$}` | 8 | src/pgfplots/axisOptions.js | verified |
| axis | `ymax` | `1.2` | 8 | src/pgfplots/axisOptions.js | verified |
| axis | `ymin` | `-1.2` | 8 | src/pgfplots/axisOptions.js | verified |
| documentclass | `border` | `4pt` | 1 | src/engine/options.js | verified |
| fill between | `every even segment/.style` | `{fill=cyan!24}` | 35 | src/pgfplots/fillBetween.js | verified |
| fill between | `every even segment/.style / fill` | `cyan!24` | 35 | src/pgfplots/fillBetween.js | verified |
| fill between | `every odd segment/.style` | `{fill=yellow!58}` | 35 | src/pgfplots/fillBetween.js | verified |
| fill between | `every odd segment/.style / fill` | `yellow!58` | 35 | src/pgfplots/fillBetween.js | verified |
| fill between | `of` | `sinpath and cospath` | 35 | src/pgfplots/fillBetween.js | verified |
...
| --- | --- | ---: | --- | --- | --- |
| expression:addplot:1 | `360` | 1 | 27 | src/pgfplots/expressions.js | verified |
| expression:addplot:2 | `360` | 1 | 34 | src/pgfplots/expressions.js | verified |
| option:addplot | `0` | 2 | 25, 32 | src/pgfplots/addplotParser.js | verified |
| option:addplot | `0.72` | 1 | 35 | src/pgfplots/addplotParser.js | verified |
| option:addplot | `1` | 2 | 25, 32 | src/pgfplots/addplotParser.js | verified |
| option:addplot | `24` | 1 | 35 | src/pgfplots/addplotParser.js | verified |
| option:addplot | `65` | 2 | 26, 33 | src/pgfplots/addplotParser.js | verified |
| option:addplot | `75` | 2 | 23, 30 | src/pgfplots/addplotParser.js | verified |
| option:axis | `-1.2` | 1 | 13 | src/pgfplots/axisOptions.js | verified |
| option:axis | `0` | 1 | 11 | src/pgfplots/axisOptions.js | verified |
| option:axis | `1` | 1 | 12 | src/pgfplots/axisOptions.js | verified |
| option:axis | `1.2` | 1 | 14 | src/pgfplots/axisOptions.js | verified |
...
| option:fill between | `24` | 1 | 38 | src/pgfplots/fillBetween.js | verified |
| option:fill between | `58` | 1 | 39 | src/pgfplots/fillBetween.js | verified |
...
| ---: | --- | --- | --- |
| 21 | `sin(360*x)` | src/pgfplots/expressions.js | verified |
| 28 | `cos(360*x)` | src/pgfplots/expressions.js | verified |
