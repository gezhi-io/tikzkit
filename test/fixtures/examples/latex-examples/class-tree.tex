% Source: /Users/kaiwu/Downloads/LaTeX-examples-master/tikz/class-tree/class-tree.tex
...
\begin{tikzpicture}
    ...
    \node[inner sep=0pt] (other) at ( 5.0,1*\leveldist) {\includegraphics[height=0.8cm]{water.jpg}};
    \draw (root) -- (ped);
    \draw (root) -- (wheel4);
    \draw (root) -- (sign);
    \draw (root) -- (wheel2);
    ...
    \node[inner sep=0pt] (lkw) at (-2.5,1.5*\leveldist) {\includegraphics[height=0.6cm]{lkw.jpg}};
    \draw (sign) -- (limit);
    \draw (sign) -- (danger);
    \draw (sign) -- (other);
    \draw (wheel2) -- (bike);
    ...
    \node[inner sep=0pt] (bikec) at (0.8,2.8*\leveldist) {\includegraphics[width=0.5cm]{bike-sign-ove.png}};
